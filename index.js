...
(function($PS) {
  ...
  var isRepeatingEdge = function (v) {
      ...
      return Data_Eq.eq(eqStartStop(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
          return "pitch";
      }))(SimplePitch.simplePitchEq))()(new Data_Symbol.IsSymbol(function () {
          return "id";
      }))(Data_Eq.eqString))))(v.left)(v.right);
  };
      ...
      return function (model) {
          ...
          var matchSlice = function (v) {
              if (v instanceof Data_List_Types.Cons && v.value1 instanceof Data_List_Types.Cons) {
                  var $121 = Data_Eq.eq(eqSliceId)(v.value0.rslice.id)(sliceId);
                  if ($121) {
                      return new Data_Maybe.Just(new Data_Tuple.Tuple(new Data_Tuple.Tuple(v.value0, v.value1.value0), v.value1.value1));
                  };
                  return Data_Maybe.Nothing.value;
              };
              return Data_Maybe.Nothing.value;
  ...
  var vertAtMid = function (transId) {
      return function (model) {
          var tryVert = function (v) {
              return mkVert(model.reduction.nextTransId)(model.reduction.nextSliceId)(v.l)(v.m)(v.r);
          };
...
(function($PS) {
  ...
  var SelectOuter = (function () {
      function SelectOuter(value0) {
          this.value0 = value0;
      };
      SelectOuter.create = function (value0) {
          return new SelectOuter(value0);
      };
      return SelectOuter;
  })();
  ...
  var addGraphTrans = function (v) {
      return function (ir) {
          ...
          var add = function (st) {
              ...
              $70.transitions = Data_Map_Internal.insert(Model.ordTransId)(v.id)(trans(st.leftId))(st.transitions);
              return $70;
          };
  ...
  var addGraphSlice = function (v) {
      return function (depth) {
          ...
          var add = function (st) {
              ...
              $77.maxd = Data_Ord.max(Data_Ord.ordNumber)(depth)(st.maxd);
              $77.maxx = Data_Ord.max(Data_Ord.ordNumber)(v.x)(st.maxx);
              $77.slices = Data_Map_Internal.insert(Model.ordSliceId)(v.id)(slice)(st.slices);
              return $77;
          };
          return Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(add);
      };
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(addGraphTrans(left.seg.trans)(left.seg.rslice.id))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(addGraphSlice(left.seg.rslice)(left.more.rdepth))(function () {
                  return Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(function (st) {
                      ...
                      $92.currentDepth = left.more.rdepth;
                      $92.leftId = left.seg.rslice.id;
                      return $92;
                  });
              });
          });
...
(function($PS) {
  ...
  var renderSlice = function (selection) {
      return function (v) {
          var selected = Data_Eq.eq(Common.eqOuterSelection)(selection)(new Common.SelSlice(v.id));
          var selectionAttr = [ cursor("pointer"), Halogen_HTML_Events.onClick(function (v1) {
              return new Common.SelectOuter((function () {
                  if (selected) {
                      return Common.SelNone.value;
                  };
                  return new Common.SelSlice(v.id);
              })());
          }) ];
              ...
              return function (xcoord) {
                  return function (ycoord) {
                      return function (fill) {
                          return Halogen_Svg_Elements.text([ Halogen_Svg_Attributes.x(xcoord), Halogen_Svg_Attributes.y(ycoord), Halogen_Svg_Attributes.text_anchor(Halogen_Svg_Attributes.AnchorMiddle.value), Halogen_Svg_Attributes.dominant_baseline(Halogen_Svg_Attributes.BaselineMiddle.value), svgFilter((function () {
                              if (fill) {
                                  return "url(#clear)";
                              };
                              return "";
          ...
          var mknote = function (i) {
              return function (note) {
                  ...
                  return mknode(label)(scalex(v.x))(scaley(v.depth) + offset(i))(false);
              };
          };
          if (v.notes instanceof Model.Inner) {
              ...
              })()) ]) ])(Data_Array.mapWithIndex(mknote)(v.notes.value0)));
          };
          return mknode([ Halogen_HTML_Core.text(Data_Show.show(Model.showStartStop(Data_Show.showArray(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "pitch";
          }))(Data_Show.showRecordFieldsNil)(SimplePitch.simplePitchShow))(Data_Show.showString)))))(v.notes)) ])(scalex(v.x))(scaley(v.depth))(true);
      };
  };
          ...
          return function (v) {
              ...
              return Data_Maybe.fromMaybe(Halogen_HTML_Core.text(""))(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Model.ordSliceId)(v.left)(slices))(function (v1) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Model.ordSliceId)(v.right)(slices))(function (v2) {
                      var selected = Data_Eq.eq(Common.eqOuterSelection)(selection)(new Common.SelTrans(v.id));
                      var selectionAttr = [ cursor("pointer"), Halogen_HTML_Events.onClick(function (v3) {
                          return new Common.SelectOuter((function () {
                              if (selected) {
                                  return Common.SelNone.value;
                              };
                      ...
                      var mkedge = function (v3) {
                          var offr = findPitchIndex(v3.right)(v2.notes);
                          var offl = findPitchIndex(v3.left)(v1.notes);
                          return Halogen_Svg_Elements.line([ Halogen_Svg_Attributes.x1(scalex(v1.x)), Halogen_Svg_Attributes.y1(scaley(v1.depth) + offset(offl)), Halogen_Svg_Attributes.x2(scalex(v2.x)), Halogen_Svg_Attributes.y2(scaley(v2.depth) + offset(offr)), Halogen_Svg_Attributes.stroke(Data_Maybe.Just.create(black)), Halogen_Svg_Attributes.strokeWidth(1.0) ]);
                      };
...
(function($PS) {
  ...
  var appComponent = function (dictMonadEffect) {
      var render = function (st) {
          return Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Proto-Voice Annotation") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
          ...
          }) ])([ Halogen_HTML_Core.text("Merge Selected") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return Common.VertAtSelected.value;
          }) ])([ Halogen_HTML_Core.text("Vert Selected") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return Common.UnMergeAtSelected.value;
          }) ])([ Halogen_HTML_Core.text("Unmerge Selected") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return Common.UnVertAtSelected.value;
          }) ])([ Halogen_HTML_Core.text("Unvert Selected") ]), (function () {
              ...
              throw new Error("Failed pattern match at Main (line 70, column 9 - line 76, column 16): " + [ st.model.constructor.name ]);
          })() ]);
      };
      ...
      var handleAction = function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 79, column 18 - line 85, column 67): " + [ v.constructor.name ]);
      };
