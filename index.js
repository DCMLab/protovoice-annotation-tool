...
(function($PS) {
  ...
  var thawPiece = function (piece) {
      ...
      return {
          ...
          nextSliceId: imax + 2 | 0,
          nextTransId: imax + 1 | 0
      };
  };
                          ...
                          var newNotes = function (counts) {
                              ...
                              var mkNote = function (i) {
                                  return function (p) {
                                      return {
                                          pitch: p,
                                          id: "note" + (Data_Show.show(Data_Show.showInt)(v1) + ("." + Data_Show.show(Data_Show.showInt)(i)))
                                      };
                                  };
                              };
      ...
      return function (f) {
          return function (v) {
              ...
              if (v instanceof Data_List_Types.Cons) {
                  ...
                  throw new Error("Failed pattern match at Model (line 173, column 37 - line 175, column 44): " + [ v1.constructor.name ]);
              };
              throw new Error("Failed pattern match at Model (line 170, column 1 - line 170, column 138): " + [ match.constructor.name, f.constructor.name, v.constructor.name ]);
          };
      };
  };
      ...
      return function (model) {
          ...
          var matchSlice = function (v) {
              if (v instanceof Data_List_Types.Cons && v.value1 instanceof Data_List_Types.Cons) {
                  var $89 = v.value0.rslice.id === sliceId;
                  if ($89) {
          ...
          if (v instanceof Data_Maybe.Just) {
              return {
                  ...
                  reduction: {
                      ...
                      segments: v.value0,
                      nextTransId: model.reduction.nextTransId + 1 | 0,
          ...
          throw new Error("Failed pattern match at Model (line 185, column 30 - line 187, column 19): " + [ v.constructor.name ]);
      };
  };
  var undoMergeAtTrans = function (transId) {
      return function (model) {
          ...
          var matchTrans = function (v) {
              if (v instanceof Data_List_Types.Cons) {
                  var $101 = v.value0.trans.id === transId;
                  if ($101) {
          ...
          throw new Error("Failed pattern match at Model (line 243, column 34 - line 245, column 19): " + [ v.constructor.name ]);
      };
  };
  var undoVertAtSlice = function (sliceId) {
      return function (model) {
          ...
          var matchSlice = function (v) {
              if (v instanceof Data_List_Types.Cons && v.value1 instanceof Data_List_Types.Cons) {
                  var $115 = v.value0.rslice.id === sliceId;
                  if ($115) {
          ...
          throw new Error("Failed pattern match at Model (line 257, column 33 - line 259, column 19): " + [ v.constructor.name ]);
      };
  };
      ...
      return function (model) {
          ...
          var matchMid = function (v) {
              if (v instanceof Data_List_Types.Cons && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Cons)) {
                  var $127 = v.value1.value0.trans.id === transId;
                  if ($127) {
                      return new Data_Maybe.Just(new Data_Tuple.Tuple({
                          l: v.value0,
                          m: v.value1.value0,
          ...
          if (v instanceof Data_Maybe.Just) {
              return {
                  ...
                  reduction: {
                      start: model.reduction.start,
                      segments: v.value0,
                      nextTransId: model.reduction.nextTransId + 2 | 0,
                      nextSliceId: model.reduction.nextSliceId + 1 | 0
                  }
              };
          };
          if (v instanceof Data_Maybe.Nothing) {
          ...
          throw new Error("Failed pattern match at Model (line 227, column 27 - line 229, column 19): " + [ v.constructor.name ]);
      };
  };
  exports["Inner"] = Inner;
...
(function($PS) {
      ...
      return function (il) {
          return function (ir) {
              ...
              var add = function (st) {
                  ...
                  $9.transitions = Data_Map_Internal.insert(Data_Ord.ordInt)(v.id)(trans)(st.transitions);
                  return $9;
              };
  ...
  var addSlice = function (v) {
      return function (depth) {
          ...
          var add = function (st) {
              ...
              $16.slices = Data_Map_Internal.insert(Data_Ord.ordInt)(v.id)(slice)(st.slices);
              return $16;
          };
          return Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(add);
      };
  ...
  var nextTrans = function (v) {
      return function (v1) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Control_Applicative.unless(Control_Monad_State_Trans.applicativeStateT(Data_Identity.monadIdentity))(v1.value0.omitSlice)(addSlice(v1.value0.seg.rslice)(v1.value0.depth)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(addTrans(v1.value0.seg.trans)(v)(v1.value0.seg.rslice.id))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))((function () {
                          ...
                          throw new Error("Failed pattern match at Unfold (line 56, column 3 - line 70, column 14): " + [ v1.value0.seg.op.constructor.name ]);
                      })())(function () {
          ...
          throw new Error("Failed pattern match at Unfold (line 47, column 1 - line 47, column 59): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
              ...
              return function (x1) {
                  return function (y) {
                      return function (fill) {
                          return Halogen_Svg_Elements.text([ Halogen_Svg_Attributes.x(x1), Halogen_Svg_Attributes.y(y), Halogen_Svg_Attributes.text_anchor(Halogen_Svg_Attributes.AnchorMiddle.value), Halogen_Svg_Attributes.dominant_baseline(Halogen_Svg_Attributes.BaselineMiddle.value), svgFilter((function () {
                              if (fill) {
                                  return "url(#clear)";
                              };
                              return "";
  ...
  var renderTrans = function (selection) {
      return function (slices) {
          return function (v) {
              ...
              return Data_Maybe.fromMaybe(Halogen_HTML_Core.text(""))(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordInt)(v.left)(slices))(function (v1) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordInt)(v.right)(slices))(function (v2) {
