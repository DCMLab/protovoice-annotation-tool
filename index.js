...
(function($PS) {
  // Generated by purs version 0.14.1
  "use strict";
  $PS["SimplePitch"] = $PS["SimplePitch"] || {};
  var exports = $PS["SimplePitch"];
  var Control_Alt = $PS["Control.Alt"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Char = $PS["Data.Char"];
  ...
  var Text_Parsing_StringParser_Combinators = $PS["Text.Parsing.StringParser.Combinators"];
  var simplePitchEq = new Data_Eq.Eq(function (x) {
      return function (y) {
          return x.acc === y.acc && x.oct === y.oct && x.step === y.step;
      };
  });
  var simplePitchOrd = new Data_Ord.Ord(function () {
      return simplePitchEq;
  }, function (v) {
      return function (v1) {
          var t2 = Data_Tuple.Tuple.create(v1.oct)(new Data_Tuple.Tuple(v1.step, v1.acc));
          var t1 = Data_Tuple.Tuple.create(v.oct)(new Data_Tuple.Tuple(v.step, v.acc));
          return Data_Ord.compare(Data_Tuple.ordTuple(Data_Ord.ordInt)(Data_Tuple.ordTuple(Data_Ord.ordInt)(Data_Ord.ordInt)))(t1)(t2);
      };
  });
  var parseAccs = (function () {
      var munch = function ($21) {
          return Text_Parsing_StringParser_Combinators.many1(Text_Parsing_StringParser_CodePoints["char"]($21));
      };
      var sharps = Data_Functor.map(Text_Parsing_StringParser.functorParser)(Data_Foldable.length(Data_List_Types.foldableNonEmptyList)(Data_Semiring.semiringInt))(Control_Alt.alt(Text_Parsing_StringParser.altParser)(munch("\u266f"))(munch("#")));
      var flats = Data_Functor.map(Text_Parsing_StringParser.functorParser)((function () {
          var $22 = Data_Ring.negate(Data_Ring.ringInt);
          var $23 = Data_Foldable.length(Data_List_Types.foldableNonEmptyList)(Data_Semiring.semiringInt);
          return function ($24) {
              return $22($23($24));
          };
  ...
  var simplePitchShow = new Data_Show.Show(function (v) {
      var o = Data_Show.show(Data_Show.showInt)(v.oct);
      var n = Data_String_CodePoints.singleton(Data_String_CodePoints.codePointFromChar(Data_Maybe.fromMaybe("X")(Data_Char.fromCharCode(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(v.step + 2 | 0)(7) + asciiA | 0))));
      var a = Data_Monoid.power(Data_Monoid.monoidString)((function () {
          var $13 = v.acc > 0;
          if ($13) {
              return "\u266f";
          };
          return "\u266d";
      })())(Data_Ord.abs(Data_Ord.ordInt)(Data_Ring.ringInt)(v.acc));
      return n + (a + o);
  });
  ...
  var parseSpelled = Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Text_Parsing_StringParser_CodePoints.oneOf(Data_Foldable.foldableArray)([ "A", "B", "C", "D", "E", "F", "G" ]))(function (name) {
      var step = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)((Data_Char.toCharCode(name) - asciiA | 0) - 2 | 0)(7);
      return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(parseAccs)(function (acc) {
          return Control_Bind.bind(Text_Parsing_StringParser.bindParser)($$parseInt)(function (oct) {
  ...
  var parseSimplePitch = function (str) {
      var v = Text_Parsing_StringParser.runParser(parseSpelled)(str);
      if (v instanceof Data_Either.Left) {
          return Data_Maybe.Nothing.value;
      };
      ...
      throw new Error("Failed pattern match at SimplePitch (line 80, column 24 - line 82, column 20): " + [ v.constructor.name ]);
  };
  exports["parseSimplePitch"] = parseSimplePitch;
  exports["simplePitchEq"] = simplePitchEq;
  exports["simplePitchOrd"] = simplePitchOrd;
  exports["simplePitchShow"] = simplePitchShow;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.1
  "use strict";
          ...
          return function (slice) {
              ...
              var findSecond = function (fst) {
                  return Data_Functor.map(Data_Maybe.functorMaybe)(function (snd) {
                      ...
                      return Data_Eq.eq(SimplePitch.simplePitchEq)(snd.pitch)(fst.pitch);
                  })(notes));
              };
              return {
                  id: id,
  ...
  var thawPiece = function (piece) {
      var thaw = function (st) {
          return function (slice) {
              var ties = Data_Functor.map(Data_Functor.functorArray)(function (v) {
                  return v.note;
              ...
              var seg = new Data_Maybe.Just({
                  ...
                  rslice: thawSlice(slice)(st.i + 1 | 0),
                  op: Freeze.value
              });
              return {
                  seg: seg,
  ...
  var showStartStop = function (dictShow) {
      return new Data_Show.Show(function (v) {
          ...
          throw new Error("Failed pattern match at Model (line 143, column 1 - line 146, column 26): " + [ v.constructor.name ]);
      });
  };
  var showSliceId = new Data_Show.Show(function (v) {
      return "s" + Data_Show.show(Data_Show.showInt)(v);
  });
  var setRightExplParent = function (rightParent) {
      return function (v) {
          if (v instanceof NoExpl) {
              return Data_Maybe.Just.create(new LeftExpl({
                  orn: Data_Maybe.Nothing.value,
          ...
          if (v instanceof RightExpl) {
              return Data_Maybe.Just.create(new DoubleExpl({
                  orn: Data_Maybe.Nothing.value,
                  leftParent: v.value0.leftParent,
                  rightParent: rightParent
              }));
          };
          ...
          throw new Error("Failed pattern match at Model (line 113, column 34 - line 118, column 24): " + [ v.constructor.name ]);
      };
  };
  ...
  var setLeftExplParent = function (leftParent) {
      return function (v) {
          if (v instanceof NoExpl) {
          ...
          if (v instanceof LeftExpl) {
              return Data_Maybe.Just.create(new DoubleExpl({
                  orn: Data_Maybe.Nothing.value,
                  leftParent: leftParent,
                  rightParent: v.value0.rightParent
              }));
          };
          if (v instanceof DoubleExpl) {
              return Data_Maybe.Just.create(new DoubleExpl({
          ...
          throw new Error("Failed pattern match at Model (line 105, column 32 - line 110, column 24): " + [ v.constructor.name ]);
      };
  };
  var setHoriExplParent = function (parent) {
      return function (v) {
          if (v instanceof NoExpl) {
              return Data_Maybe.Just.create(new HoriExpl(parent));
          };
          if (v instanceof HoriExpl) {
              return Data_Maybe.Just.create(new HoriExpl(parent));
          };
  ...
  var isRepeatingEdge = function (v) {
      if (v.left instanceof Inner && v.right instanceof Inner) {
          return Data_Eq.eq(SimplePitch.simplePitchEq)(v.left.value0.pitch)(v.right.value0.pitch);
      };
      return false;
  };
  var incT = function (v) {
  ...
  var getParents = function (v) {
      ...
      throw new Error("Failed pattern match at Model (line 206, column 14 - line 209, column 50): " + [ v.constructor.name ]);
  };
  var getInnerNotes = function (slice) {
      ...
      throw new Error("Failed pattern match at Model (line 219, column 23 - line 222, column 23): " + [ slice.notes.constructor.name ]);
  };
  var genericRightOrnament = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Model (line 33, column 1 - line 33, column 64): " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var genericParents = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Model (line 200, column 1 - line 200, column 52): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var showParents = new Data_Show.Show(function (p) {
      return Data_Show_Generic.genericShow(genericParents)(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
          return "NoParents";
      })))(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsArgument(showSliceId))(new Data_Symbol.IsSymbol(function () {
          return "VertParent";
          ...
          return "right";
      }))(Data_Show.showRecordFieldsNil)(showSliceId))(showSliceId))))(new Data_Symbol.IsSymbol(function () {
          return "MergeParents";
      })))))(p);
  });
  var genericNoteExplanation = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Model (line 75, column 1 - line 75, column 68): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return NoExpl.value;
      };
      if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inl) {
          return new HoriExpl(x.value0.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0 instanceof Data_Generic_Rep.Inl)) {
          return new RightExpl(x.value0.value0.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0.value0 instanceof Data_Generic_Rep.Inl))) {
          return new LeftExpl(x.value0.value0.value0.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0.value0 instanceof Data_Generic_Rep.Inr))) {
          return new DoubleExpl(x.value0.value0.value0.value0);
      };
      throw new Error("Failed pattern match at Model (line 75, column 1 - line 75, column 68): " + [ x.constructor.name ]);
  });
  var genericLeftOrnament = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Model (line 44, column 1 - line 44, column 62): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var showNoteExplanation = new Data_Show.Show(function (o) {
      return Data_Show_Generic.genericShow(genericNoteExplanation)(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
          ...
          return "pitch";
      }))(Data_Show.showRecordFieldsNil)(SimplePitch.simplePitchShow))(Data_Show.showString))))(new Data_Symbol.IsSymbol(function () {
          return "HoriExpl";
      })))(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsArgument(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "leftParent";
      }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "pitch";
      }))(Data_Show.showRecordFieldsNil)(SimplePitch.simplePitchShow))(Data_Show.showString))))(Data_Maybe.showMaybe(showLeftOrnament)))))(new Data_Symbol.IsSymbol(function () {
          return "LeftExpl";
      })))(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsArgument(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "leftParent";
      }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "pitch";
      }))(Data_Show.showRecordFieldsNil)(SimplePitch.simplePitchShow))(Data_Show.showString))))(Data_Maybe.showMaybe(showDoubleOrnament)))(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "id";
      }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "pitch";
      }))(Data_Show.showRecordFieldsNil)(SimplePitch.simplePitchShow))(Data_Show.showString))))))(new Data_Symbol.IsSymbol(function () {
  ...
  var showReduction = function (v) {
      var showSegment$prime = function (indent) {
          return function (v1) {
              return Data_Monoid.power(Data_Monoid.monoidString)(" ")(indent) + ("trans: " + (Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "pitch";
              }))(Data_Show.showRecordFieldsNil)(SimplePitch.simplePitchShow))(Data_Show.showString)))))(showStartStop(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "id";
              }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "pitch";
              }))(Data_Show.showRecordFieldsNil)(SimplePitch.simplePitchShow))(Data_Show.showString))))))))(Data_Show.showArray(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "left";
              }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "right";
              }))(Data_Show.showRecordFieldsNil)(showStartStop(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "pitch";
              }))(Data_Show.showRecordFieldsNil)(SimplePitch.simplePitchShow))(Data_Show.showString)))))))))))(v1.trans) + (", op:" + showChildren(indent)(v1.op))));
          };
      };
      var showSegment = function (indent) {
          return function (v1) {
              return Data_Monoid.power(Data_Monoid.monoidString)(" ")(indent) + ("trans: " + (Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "pitch";
              }))(Data_Show.showRecordFieldsNil)(SimplePitch.simplePitchShow))(Data_Show.showString)))))))))))(v1.trans) + (", rslice: " + (Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "id";
              }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "notes";
              }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "x";
              }))(Data_Show.showRecordFieldsNil)(Data_Show.showNumber))(showParents))(showStartStop(Data_Show.showArray(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "expl";
              }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "note";
              }))(Data_Show.showRecordFieldsNil)(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "pitch";
              }))(Data_Show.showRecordFieldsNil)(SimplePitch.simplePitchShow))(Data_Show.showString))))(showNoteExplanation))))))(showSliceId)))(v1.rslice) + (", op:" + showChildren(indent)(v1.op))))));
          };
      };
      var showChildren = function (indent) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at Model (line 283, column 25 - line 296, column 44): " + [ v1.constructor.name ]);
          };
      };
  ...
  var functorStartStop = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at Model (line 141, column 1 - line 141, column 54): " + [ m.constructor.name ]);
      };
  });
  ...
  var eqParents = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof NoParents && y instanceof NoParents) {
              return true;
          };
          if (x instanceof VertParent && y instanceof VertParent) {
              return Data_Eq.eq(eqSliceId)(x.value0)(y.value0);
          };
          if (x instanceof MergeParents && y instanceof MergeParents) {
              return Data_Eq.eq(eqSliceId)(x.value0.left)(y.value0.left) && Data_Eq.eq(eqSliceId)(x.value0.right)(y.value0.right);
          };
          return false;
      };
  });
  ...
  var eqDoubleOrnament = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof RootNote && y instanceof RootNote) {
              return true;
          };
  ...
  var eqNoteExplanation = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof HoriExpl && y instanceof HoriExpl) {
              return x.value0.id === y.value0.id && Data_Eq.eq(SimplePitch.simplePitchEq)(x.value0.pitch)(y.value0.pitch);
          };
          if (x instanceof RightExpl && y instanceof RightExpl) {
              return x.value0.leftParent.id === y.value0.leftParent.id && Data_Eq.eq(SimplePitch.simplePitchEq)(x.value0.leftParent.pitch)(y.value0.leftParent.pitch) && Data_Eq.eq(Data_Maybe.eqMaybe(eqRightOrnament))(x.value0.orn)(y.value0.orn);
          };
          if (x instanceof LeftExpl && y instanceof LeftExpl) {
              return Data_Eq.eq(Data_Maybe.eqMaybe(eqLeftOrnament))(x.value0.orn)(y.value0.orn) && (x.value0.rightParent.id === y.value0.rightParent.id && Data_Eq.eq(SimplePitch.simplePitchEq)(x.value0.rightParent.pitch)(y.value0.rightParent.pitch));
          };
          if (x instanceof DoubleExpl && y instanceof DoubleExpl) {
              return x.value0.leftParent.id === y.value0.leftParent.id && Data_Eq.eq(SimplePitch.simplePitchEq)(x.value0.leftParent.pitch)(y.value0.leftParent.pitch) && Data_Eq.eq(Data_Maybe.eqMaybe(eqDoubleOrnament))(x.value0.orn)(y.value0.orn) && (x.value0.rightParent.id === y.value0.rightParent.id && Data_Eq.eq(SimplePitch.simplePitchEq)(x.value0.rightParent.pitch)(y.value0.rightParent.pitch));
          };
          return false;
      };
  });
          ...
          return function (model) {
              var vertEdgesRight = function (edges) {
                  return function (slice) {
                      var v = function (v1) {
                          ...
                          throw new Error("Failed pattern match at Model (line 530, column 1 - line 530, column 80): " + [ edges.constructor.name, slice.constructor.name ]);
                      };
                      if (slice.notes instanceof Inner) {
                          var replaceLeft = function (v1) {
                              var v2 = function (v3) {
                                  ...
                                  throw new Error("Failed pattern match at Model (line 530, column 1 - line 530, column 80): " + [ v1.constructor.name ]);
                              };
                              if (v1.left instanceof Inner) {
                                  var $347 = Data_Array.find(function (n) {
                                      return n.note.id === v1.left.value0.id;
                                  })(slice.notes.value0);
                                  if ($347 instanceof Data_Maybe.Just) {
                                      if ($347.value0.expl instanceof HoriExpl) {
                                          return [ {
                                              left: new Inner($347.value0.expl.value0),
                                              right: v1.right
                                          } ];
                                      };
                                      return v2(true);
                      ...
                      if (slice.notes instanceof Inner) {
                          var replaceRight = function (v1) {
                              ...
                              if (v1.right instanceof Inner) {
                                  var $365 = Data_Array.find(function (n) {
                                      return n.note.id === v1.right.value0.id;
                                  })(slice.notes.value0);
                                  if ($365 instanceof Data_Maybe.Just) {
                                      if ($365.value0.expl instanceof HoriExpl) {
                                          return [ {
                                              left: v1.left,
                                              right: new Inner($365.value0.expl.value0)
                                          } ];
                                      };
                                      return v2(true);
                                  };
              ...
              var doSegment$prime = function (upFromLeft) {
                  return function (seg) {
                      if (seg.op instanceof Freeze) {
                          ...
                          if (upFromLeft instanceof Data_List_Types.Cons) {
                              return Data_Either.Right.create({
                                  "seg'": (function () {
                                      var $379 = {};
                                      for (var $380 in seg) {
                                          if ({}.hasOwnProperty.call(seg, $380)) {
                                              $379[$380] = seg[$380];
                                          };
                                      };
                                      $379.trans = {
                          ...
                          throw new Error("Failed pattern match at Model (line 595, column 15 - line 597, column 86): " + [ upFromLeft.constructor.name ]);
                      };
                          ...
                          return Control_Bind.bind(Data_Either.bindEither)(doSegment(upFromLeft)(seg.op.value0.childl))(function (v) {
                              return Control_Bind.bind(Data_Either.bindEither)(doSegment$prime(v.rUp)(seg.op.value0.childr))(function (v1) {
                                  var segNewOp = (function () {
                                      var $386 = {};
                                      for (var $387 in seg) {
                                          if ({}.hasOwnProperty.call(seg, $387)) {
                                              $386[$387] = seg[$387];
                                          };
                                      };
                                      $386.op = new Split({
                                  ...
                                  return Control_Bind.bind(Data_Either.bindEither)((function () {
                                      var $389 = noteInSlice(seg.op.value0.childl.rslice);
                                      if ($389) {
                                          var $390 = explIsSplit(expl);
                                          if ($390) {
                                              return Control_Applicative.pure(Data_Either.applicativeEither)((function () {
                                                  var $391 = {};
                                                  for (var $392 in segNewOp) {
                                                      if ({}.hasOwnProperty.call(segNewOp, $392)) {
                                                          $391[$392] = segNewOp[$392];
                                                      };
                                                  };
                                                  $391.trans = {
                                      ...
                                      return Control_Bind.bind(Data_Either.bindEither)(vertEdgesLeft(v["seg'"].trans.edges)(v["seg'"].rslice))(function (leftParentEdges) {
                                          return Control_Bind.bind(Data_Either.bindEither)(vertEdgesRight(v2["seg'"].trans.edges)(v1["seg'"].rslice))(function (rightParentEdges) {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Data_Either.bindEither)((function () {
                                                  var $404 = (noteInSlice(seg.op.value0.childl.rslice) || noteInSlice(seg.op.value0.childm.rslice)) && !explIsHori(expl);
                                                  if ($404) {
                                                      return Data_Either.Left.create("Cannot explain a hori note with a split. noteId = " + (Data_Show.show(Data_Show.showString)(noteId) + (", childl.rslice = " + (Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                                                          ...
                                                          return "pitch";
                                                      }))(Data_Show.showRecordFieldsNil)(SimplePitch.simplePitchShow))(Data_Show.showString))))(showNoteExplanation))))))(showSliceId)))(seg.op.value0.childl.rslice) + (", childm.rslice = " + Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                                                          return "id";
                                                      }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                                                          return "notes";
                                                      }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                                                          ...
                                                          return "pitch";
                                                      }))(Data_Show.showRecordFieldsNil)(SimplePitch.simplePitchShow))(Data_Show.showString))))(showNoteExplanation))))))(showSliceId)))(seg.op.value0.childm.rslice))))));
                                                  };
                                                  ...
                                                  return Control_Applicative.pure(Data_Either.applicativeEither)({
                                                      "seg'": (function () {
                                                          var $405 = {};
                                                          for (var $406 in seg) {
                                                              if ({}.hasOwnProperty.call(seg, $406)) {
                                                                  $405[$406] = seg[$406];
                                                              };
                                                          };
                                                          $405.op = new Hori({
                      ...
                      throw new Error("Failed pattern match at Model (line 594, column 31 - line 635, column 12): " + [ seg.op.constructor.name ]);
                  };
              };
              var doSegment = function (upFromLeft) {
                  return function (seg) {
                      var rslice$prime = (function () {
                          var $418 = noteInSlice(seg.rslice);
                          if ($418) {
              ...
              var traverseTop = function (upFromLeft) {
                  return function (v) {
                      ...
                      throw new Error("Failed pattern match at Model (line 581, column 28 - line 586, column 29): " + [ v.constructor.name ]);
                  };
              };
              ...
              throw new Error("Failed pattern match at Model (line 531, column 40 - line 533, column 23): " + [ v.constructor.name ]);
          };
      };
  };
              ...
              var go = function (v) {
                  return function (v1) {
                      ...
                      if (v1 instanceof Data_List_Types.Cons) {
                          ...
                          throw new Error("Failed pattern match at Model (line 396, column 36 - line 398, column 50): " + [ v2.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Model (line 393, column 3 - line 393, column 64): " + [ v.constructor.name, v1.constructor.name ]);
                  };
              };
  ...
  var mkMerge = function (tid) {
      return function (leftId) {
          return function (seg1) {
              return function (seg2) {
                  var pars = new MergeParents({
                      left: leftId,
                      right: seg2.rslice.id
                  });
                  var op = new Split({
                      childl: setParents(pars)(seg1),
  ...
  var mergeAtSlice = function (sliceId) {
      return function (model) {
          var tryMerge = function (leftId) {
              return function (v) {
                  return Data_Either.Right.create(new Data_List_Types.Cons(mkMerge(model.reduction.nextTransId)(leftId)(v.seg1)(v.seg2), Data_List_Types.Nil.value));
              };
          };
          var matchSlice = function (v) {
              if (v instanceof Data_List_Types.Cons && v.value1 instanceof Data_List_Types.Cons) {
                  var $444 = Data_Eq.eq(eqSliceId)(v.value0.rslice.id)(sliceId);
                  if ($444) {
          ...
          throw new Error("Failed pattern match at Model (line 417, column 30 - line 419, column 23): " + [ v.constructor.name ]);
      };
  };
                          ...
                          if (Data_Boolean.otherwise) {
                              ...
                              var countPitches = function (notes) {
                                  return Data_Foldable.foldl(Data_Foldable.foldableArray)(function (counts) {
                                      return function (n) {
                                          return Data_Map_Internal.insertWith(SimplePitch.simplePitchOrd)(Data_Semiring.add(Data_Semiring.semiringInt))(n.note.pitch)(1)(counts);
                                      };
      ...
      return function (model) {
          ...
          var matchMid = function (v) {
              if (v instanceof Data_List_Types.Cons && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Cons)) {
                  var $472 = Data_Eq.eq(eqTransId)(v.value1.value0.trans.id)(transId);
                  if ($472) {
                      return new Data_Maybe.Just(new Data_Tuple.Tuple({
                          l: v.value0,
                          m: v.value1.value0,
          ...
          throw new Error("Failed pattern match at Model (line 471, column 27 - line 481, column 23): " + [ v.constructor.name ]);
      };
  };
  ...
  var undoMergeAtTrans = function (transId) {
      return function (model) {
          ...
          var matchTrans = function (v) {
              if (v instanceof Data_List_Types.Cons) {
                  var $491 = Data_Eq.eq(eqTransId)(v.value0.trans.id)(transId);
                  if ($491) {
          ...
          throw new Error("Failed pattern match at Model (line 495, column 34 - line 497, column 23): " + [ v.constructor.name ]);
      };
  };
  var undoVertAtSlice = function (sliceId) {
      return function (model) {
          ...
          var matchSlice = function (v) {
              if (v instanceof Data_List_Types.Cons && v.value1 instanceof Data_List_Types.Cons) {
                  var $507 = Data_Eq.eq(eqSliceId)(v.value0.rslice.id)(sliceId);
                  if ($507) {
                      return new Data_Maybe.Just(new Data_Tuple.Tuple({
                          pl: v.value0,
                          pr: v.value1.value0
          ...
          throw new Error("Failed pattern match at Model (line 513, column 33 - line 515, column 23): " + [ v.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var transSelected = function (v) {
      if (v instanceof SelTrans) {
          return true;
      };
      return false;
  };
  var sliceSelected = function (v) {
  ...
  var genericOuterSelection = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Common (line 18, column 1 - line 18, column 61): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var showOuterSelection = new Data_Show.Show(function (os) {
      return Data_Show_Generic.genericShow(genericOuterSelection)(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
          ...
          return "parents";
      }))(Data_Show.showRecordFieldsNil)(Model.showParents))(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "id";
      }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "pitch";
      }))(Data_Show.showRecordFieldsNil)(SimplePitch.simplePitchShow))(Data_Show.showString))))(Model.showNoteExplanation))))(new Data_Symbol.IsSymbol(function () {
          return "SelNote";
      }))))))(os);
  });
  var eqOuterSelection = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof SelNote && y instanceof SelNote) {
              return Data_Eq.eq(Model.eqNoteExplanation)(x.value0.expl)(y.value0.expl) && (x.value0.note.id === y.value0.note.id && Data_Eq.eq(SimplePitch.simplePitchEq)(x.value0.note.pitch)(y.value0.note.pitch)) && Data_Eq.eq(Model.eqParents)(x.value0.parents)(y.value0.parents);
          };
          return false;
      };
  });
      ...
      return function (sliceId) {
          return function (parNote) {
              var v = function (v1) {
                  ...
                  throw new Error("Failed pattern match at Common (line 53, column 1 - line 53, column 63): " + [ sel.constructor.name, sliceId.constructor.name, parNote.constructor.name ]);
              };
              if (sel instanceof SelNote) {
                  ...
                  var v1 = function (v2) {
                      var v3 = function (v4) {
                          ...
                          var v5 = function (v6) {
                              ...
                              throw new Error("Failed pattern match at Common (line 53, column 1 - line 53, column 63): " + [ sel.value0.parents.constructor.name ]);
                          };
                          if (sel.value0.parents instanceof Model.VertParent) {
                              var $77 = Data_Eq.eq(Model.eqSliceId)(sliceId)(sel.value0.parents.value0);
                              if ($77) {
                                  var $78 = Model.setHoriExplParent(parNote)(sel.value0.expl);
                                  if ($78 instanceof Data_Maybe.Just) {
                                      return setExpl($78.value0);
                                  };
                                  return v5(true);
                              };
                              return v5(true);
                      ...
                      if (sel.value0.parents instanceof Model.MergeParents) {
                          var $82 = Data_Eq.eq(Model.eqSliceId)(sliceId)(sel.value0.parents.value0.right);
                          if ($82) {
                              var $83 = Model.setRightExplParent(parNote)(sel.value0.expl);
                              if ($83 instanceof Data_Maybe.Just) {
                                  return setExpl($83.value0);
                              };
                              return v3(true);
                          };
                          return v3(true);
                  ...
                  if (sel.value0.parents instanceof Model.MergeParents) {
                      var $89 = Data_Eq.eq(Model.eqSliceId)(sliceId)(sel.value0.parents.value0.left);
                      if ($89) {
                          var $90 = Model.setLeftExplParent(parNote)(sel.value0.expl);
                          if ($90 instanceof Data_Maybe.Just) {
                              return setExpl($90.value0);
                          };
                          return v1(true);
                      };
                      return v1(true);
  ...
  exports["sliceSelected"] = sliceSelected;
  exports["transSelected"] = transSelected;
...
(function($PS) {
  ...
  var renderNoteExplanation = function (v) {
      return function (v1) {
          if (v1 instanceof Common.SelNote) {
              return Halogen_HTML_Core.text(Data_Show.show(SimplePitch.simplePitchShow)(v1.value0.note.pitch) + (" (" + (v1.value0.note.id + ")")));
          };
          return Halogen_HTML_Core.text("No note selected.");
      };
  };
  ...
  var renderSlice = function (selection) {
      return function (v) {
          var selected = Data_Eq.eq(Common.eqOuterSelection)(selection)(new Common.SelSlice(v.slice.id));
          var selectionAttr = [ cursor("pointer"), Halogen_HTML_Events.onClick(function (v1) {
              return new Common.Select((function () {
                  if (selected) {
                      return Common.SelNone.value;
                  };
                  return new Common.SelSlice(v.slice.id);
              })());
          }) ];
          ...
          var mknode = function (text) {
              return function (xcoord) {
                  return function (ycoord) {
                      return function (sel) {
                          return function (drawBg) {
                              return function (attr) {
                                  var label = Halogen_Svg_Elements.text([ Halogen_Svg_Attributes.x(xcoord), Halogen_Svg_Attributes.y(ycoord), Halogen_Svg_Attributes.text_anchor(Halogen_Svg_Attributes.AnchorMiddle.value), Halogen_Svg_Attributes.dominant_baseline(Halogen_Svg_Attributes.BaselineMiddle.value) ])(text);
                                  ...
                                  return Halogen_Svg_Elements.g(attr)(Data_Semigroup.append(Data_Semigroup.semigroupArray)((function () {
                                      if (drawBg) {
                                          return [ bg ];
                                      };
                                      return [  ];
          ...
          var activeParent = (function () {
              if (selection instanceof Common.SelNote) {
          ...
          var mknote = function (i) {
              return function (v1) {
                  var nselected = Common.noteIsSelected(selection)(new Model.Inner(v1.note));
                  ...
                  var attrsSel = [ cursor("pointer"), Halogen_HTML_Events.onClick(function (ev) {
                      var $27 = Web_UIEvent_MouseEvent.ctrlKey(ev);
                      if ($27) {
                          if (activeParent) {
                              return Common.addParentToNote(selection)(v.slice.id)(v1.note);
                          };
                  ...
                  return mknode(label)(scalex(v.slice.x))(scaley(v.depth) + offset(i))(nselected)(nselectable)((function () {
                      if (clickable) {
                          return attrsSel;
                      };
                      return [  ];
          ...
          return mknode([ Halogen_HTML_Core.text(Data_Show.show(Model.showStartStop(Data_Show.showArray(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "pitch";
          }))(Data_Show.showRecordFieldsNil)(SimplePitch.simplePitchShow))(Data_Show.showString))))(Model.showNoteExplanation)))))(v.slice.notes)) ])(scalex(v.slice.x))(scaley(v.depth))(false)(true)([  ]);
      };
  };
  ...
  var renderTrans = function (selection) {
      return function (slices) {
          return function (v) {
              var transSelected = Data_Eq.eq(Common.eqOuterSelection)(selection)(new Common.SelTrans(v.id));
              var selectionAttr = [ cursor("pointer"), Halogen_HTML_Events.onClick(function (v1) {
                  return new Common.Select((function () {
                      if (transSelected) {
                          return Common.SelNone.value;
                      };
                      return new Common.SelTrans(v.id);
                  })());
              }) ];
              var findPitchIndex = function (v1) {
                  return function (v2) {
                      if (v1 instanceof Model.Inner && v2 instanceof Model.Inner) {
                          return Data_Maybe.fromMaybe(0)(Data_Array.findIndex(function (n) {
                              return Data_Eq.eq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                                  return "pitch";
                              }))(SimplePitch.simplePitchEq))()(new Data_Symbol.IsSymbol(function () {
                                  return "id";
                              }))(Data_Eq.eqString)))(n.note)(v1.value0);
                          })(v2.value0));
                      };
                      return 0;
                  };
              ...
              return Data_Maybe.fromMaybe(Halogen_HTML_Core.text(""))(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Model.ordSliceId)(v.left)(slices))(function (v1) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Model.ordSliceId)(v.right)(slices))(function (v2) {
                      ...
                      var edgeLines = Data_Functor.map(Data_Functor.functorArray)(mkedge)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v.edges.regular)(v.edges.passing));
  ...
  var renderReduction = function (graph) {
      return function (selection) {
          var width = scalex(graph.maxx + 2.0);
          var svgTranss = Data_Functor.map(Data_Functor.functorArray)(renderTrans(selection)(graph.slices))(Data_Array.fromFoldable(Data_List_Types.foldableList)(Data_Map_Internal.values(graph.transitions)));
          var svgSlices = Data_Functor.map(Data_Functor.functorArray)(renderSlice(selection))(Data_Array.fromFoldable(Data_List_Types.foldableList)(Data_Map_Internal.values(graph.slices)));
          var height = scaley(graph.maxd + 4.0);
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("overflow-x: scroll;") ])([ Halogen_Svg_Elements.svg([ Halogen_Svg_Attributes.width(width), Halogen_Svg_Attributes.height(height), Halogen_Svg_Attributes.viewBox(-scalex(1.0))(-scaley(1.0))(width)(height) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(svgTranss)(svgSlices)) ]);
      };
  };
  ...
  var foldAgenda = function (v) {
      return function (v1) {
          ...
          if (v1 instanceof Data_List_Types.Cons && v1.value1 instanceof Data_List_Types.Nil) {
              ...
              throw new Error("Failed pattern match at Unfold (line 45, column 3 - line 50, column 24): " + [ v1.value0.seg.op.constructor.name ]);
          };
          if (v1 instanceof Data_List_Types.Cons && v1.value1 instanceof Data_List_Types.Cons) {
              ...
              throw new Error("Failed pattern match at Unfold (line 54, column 3 - line 71, column 45): " + [ v1.value0.seg.op.constructor.name ]);
          };
          throw new Error("Failed pattern match at Unfold (line 36, column 1 - line 39, column 41): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  ...
  var addGraphTrans = function (v) {
      return function (ir) {
          ...
          var add = function (st) {
              ...
              $73.transitions = Data_Map_Internal.insert(Model.ordTransId)(v.id)(trans(st.leftId))(st.transitions);
              return $73;
          };
  ...
  var addGraphSlice = function (slice) {
      return function (depth) {
          ...
          var add = function (st) {
              ...
              $78.maxd = Data_Ord.max(Data_Ord.ordNumber)(depth)(st.maxd);
              $78.maxx = Data_Ord.max(Data_Ord.ordNumber)(slice.x)(st.maxx);
              $78.slices = Data_Map_Internal.insert(Model.ordSliceId)(slice.id)(gslice)(st.slices);
              return $78;
          };
          return Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(add);
      };
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(addGraphTrans(left.seg.trans)(left.seg.rslice.id))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(addGraphSlice(left.seg.rslice)(left.more.rdepth))(function () {
                  return Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(function (st) {
                      ...
                      $90.currentDepth = left.more.rdepth;
                      $90.leftId = left.seg.rslice.id;
                      return $90;
                  });
              });
          });
...
(function($PS) {
  ...
  var pieceFromJSON = function (piece) {
      return Data_Traversable["for"](Data_Maybe.applicativeMaybe)(Data_Traversable.traversableArray)(piece)(function (slice) {
          return Data_Traversable["for"](Data_Maybe.applicativeMaybe)(Data_Traversable.traversableArray)(slice)(function (note) {
              ...
              })(SimplePitch.parseSimplePitch(note.pitch));
          });
      });
  };
                      ...
                      if (modelAndSel instanceof Data_Maybe.Just) {
                          ...
                          if (v instanceof Data_Either.Right) {
                              return Control_Monad_State_Class.put(dictMonadState)((function () {
                                  ...
                                  $21.model = new Data_Maybe.Just(v.value0);
                                  $21.selected = Common.SelNone.value;
                                  return $21;
                              })());
                          };
                          throw new Error("Failed pattern match at Main (line 60, column 28 - line 62, column 75): " + [ v.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Main (line 58, column 3 - line 62, column 75): " + [ modelAndSel.constructor.name ]);
                  });
              };
          };
      };
  ...
  var appComponent = function (dictMonadEffect) {
      var render = function (st) {
          return Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Proto-Voice Annotation") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              ...
              return Common.MergeAtSelected.value;
          }), Halogen_HTML_Properties.enabled(Common.sliceSelected(st.selected)) ])([ Halogen_HTML_Core.text("Merge Selected") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return Common.VertAtSelected.value;
          }), Halogen_HTML_Properties.enabled(Common.transSelected(st.selected)) ])([ Halogen_HTML_Core.text("Vert Selected") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return Common.UnMergeAtSelected.value;
          }), Halogen_HTML_Properties.enabled(Common.transSelected(st.selected)) ])([ Halogen_HTML_Core.text("Unmerge Selected") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return Common.UnVertAtSelected.value;
          }), Halogen_HTML_Properties.enabled(Common.sliceSelected(st.selected)) ])([ Halogen_HTML_Core.text("Unvert Selected") ]), (function () {
              if (st.model instanceof Data_Maybe.Nothing) {
                  return Halogen_HTML_Core.text("");
              };
              if (st.model instanceof Data_Maybe.Just) {
                  var graph = Unfold.evalGraph(st.model.value0.reduction);
                  return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Render.renderNoteExplanation(graph)(st.selected) ]), Render.renderReduction(graph)(st.selected) ]);
              };
              throw new Error("Failed pattern match at Main (line 87, column 9 - line 96, column 16): " + [ st.model.constructor.name ]);
          })(), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Selection: "), Halogen_HTML_Core.text(Data_Show.show(Common.showOuterSelection)(st.selected)) ]), Halogen_HTML_Elements.pre_([ Halogen_HTML_Core.text(Data_Maybe.maybe("No Piece Loaded")(function ($51) {
          ...
          return function (v) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (doc) {
                      return Halogen_Query_HalogenM["subscribe'"](function (sid) {
                          return Halogen_Query_Event.eventListener(Web_UIEvent_KeyboardEvent_EventTypes.keyup)(Web_HTML_HTMLDocument.toEventTarget(doc))((function () {
                              var $52 = Data_Functor.map(Data_Maybe.functorMaybe)(Common.HandleKey.create);
                              return function ($53) {
                                  return $52(Web_UIEvent_KeyboardEvent.fromEvent($53));
                              };
                          })());
                      });
                  });
              };
              if (v instanceof Common.HandleKey) {
                  var v1 = Web_UIEvent_KeyboardEvent.key(v.value0);
                  if (v1 === "m") {
                      return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(pr(v.value0))(handleAction(Common.MergeAtSelected.value));
                  };
                  if (v1 === "M") {
                      return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(pr(v.value0))(handleAction(Common.UnMergeAtSelected.value));
                  };
                  if (v1 === "v") {
                      return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(pr(v.value0))(handleAction(Common.VertAtSelected.value));
                  };
                  if (v1 === "V") {
                      return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(pr(v.value0))(handleAction(Common.UnVertAtSelected.value));
                  };
                  if (v1 === "Enter") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(pr(v.value0))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                              if (st.selected instanceof Common.SelTrans) {
                                  return handleAction(Common.VertAtSelected.value);
                              };
                              if (st.selected instanceof Common.SelSlice) {
                                  return handleAction(Common.MergeAtSelected.value);
                              };
                  ...
                  if (v1 === "Backspace") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(pr(v.value0))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                              if (st.selected instanceof Common.SelTrans) {
                                  return handleAction(Common.UnMergeAtSelected.value);
                              };
                              if (st.selected instanceof Common.SelSlice) {
                                  return handleAction(Common.UnVertAtSelected.value);
                              };
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          });
                      });
              ...
              if (v instanceof Common.LoadPiece) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $43.model = Data_Maybe.Just.create(Model.loadPiece(v.value0));
                      $43.selected = Common.SelNone.value;
                      return $43;
                  });
              };
              ...
              if (v instanceof Common.SetNoteExplanation) {
                  return tryModelAction(Halogen_Query_HalogenM.monadStateHalogenM)(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Data_Function["const"](new Data_Maybe.Just(v.value0)))(function (v1) {
                      return Model.noteSetExplanation(v1.noteId)(v1.expl);
                  });
              };
              throw new Error("Failed pattern match at Main (line 104, column 18 - line 139, column 62): " + [ v.constructor.name ]);
          };
      })();
