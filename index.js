...
(function($PS) {
  ...
  var thawSlice = function (slice) {
      return function (id) {
          return {
              id: id,
              notes: Inner.create(Data_Functor.map(Data_Functor.functorArray)(function (v) {
                  return v.note;
              })(slice)),
  ...
  var showStartStop = function (dictShow) {
      return new Data_Show.Show(function (v) {
          ...
          throw new Error("Failed pattern match at Model (line 41, column 1 - line 44, column 26): " + [ v.constructor.name ]);
      });
  };
  ...
  var getParents = function (v) {
      ...
      throw new Error("Failed pattern match at Model (line 99, column 14 - line 102, column 50): " + [ v.constructor.name ]);
  }; 
              ...
              var go = function (v) {
                  return function (v1) {
                      ...
                      if (v1 instanceof Data_List_Types.Cons) {
                          ...
                          throw new Error("Failed pattern match at Model (line 238, column 36 - line 240, column 50): " + [ v2.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Model (line 235, column 3 - line 235, column 64): " + [ v.constructor.name, v1.constructor.name ]);
                  };
              };
      ...
      return function (model) {
          ...
          var matchSlice = function (v) {
              if (v instanceof Data_List_Types.Cons && v.value1 instanceof Data_List_Types.Cons) {
                  var $145 = Data_Eq.eq(eqSliceId)(v.value0.rslice.id)(sliceId);
                  if ($145) {
          ...
          throw new Error("Failed pattern match at Model (line 259, column 30 - line 261, column 23): " + [ v.constructor.name ]);
      };
  };
  var undoMergeAtTrans = function (transId) {
      return function (model) {
          var tryUnmerge = function (v) {
              return function (seg) {
                  if (seg.op instanceof Split) {
                      return Data_Either.Right.create(new Data_List_Types.Cons(setParents(NoParents.value)(seg.op.value0.childl), new Data_List_Types.Cons(seg.op.value0.childr, Data_List_Types.Nil.value)));
                  };
          ...
          var matchTrans = function (v) {
              if (v instanceof Data_List_Types.Cons) {
                  var $158 = Data_Eq.eq(eqTransId)(v.value0.trans.id)(transId);
                  if ($158) {
          ...
          throw new Error("Failed pattern match at Model (line 337, column 34 - line 339, column 23): " + [ v.constructor.name ]);
      };
  };
  var undoVertAtSlice = function (sliceId) {
      return function (model) {
          var tryUnvert = function (v) {
              return function (v1) {
                  if (v1.pl.op instanceof Hori) {
                      return Data_Either.Right.create(new Data_List_Types.Cons(setParents(NoParents.value)(v1.pl.op.value0.childl), new Data_List_Types.Cons(setParents(NoParents.value)(v1.pl.op.value0.childm), new Data_List_Types.Cons(v1.pl.op.value0.childr, Data_List_Types.Nil.value))));
                  };
          ...
          var matchSlice = function (v) {
              if (v instanceof Data_List_Types.Cons && v.value1 instanceof Data_List_Types.Cons) {
                  var $174 = Data_Eq.eq(eqSliceId)(v.value0.rslice.id)(sliceId);
                  if ($174) {
                      return new Data_Maybe.Just(new Data_Tuple.Tuple({
                          pl: v.value0,
                          pr: v.value1.value0
          ...
          throw new Error("Failed pattern match at Model (line 351, column 33 - line 353, column 23): " + [ v.constructor.name ]);
      };
  };
      ...
      return function (model) {
          ...
          var matchMid = function (v) {
              if (v instanceof Data_List_Types.Cons && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Cons)) {
                  var $188 = Data_Eq.eq(eqTransId)(v.value1.value0.trans.id)(transId);
                  if ($188) {
                      return new Data_Maybe.Just(new Data_Tuple.Tuple({
                          l: v.value0,
                          m: v.value1.value0,
          ...
          throw new Error("Failed pattern match at Model (line 313, column 27 - line 323, column 23): " + [ v.constructor.name ]);
      };
  };
  exports["Inner"] = Inner;
...
(function($PS) {
  ...
  var noteIsSelected = function (v) {
      return function (v1) {
          if (v instanceof SelNote && v1 instanceof Model.Inner) {
              return v.value0.note === v1.value0.id;
          };
          return false;
      };
  };
  ...
  var showOuterSelection = new Data_Show.Show(function (os) {
      return Data_Show_Generic.genericShow(genericOuterSelection)(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
          ...
          return "parentSlices";
      }))(Data_Show.showRecordFieldsNil)(Data_Show.showArray(Model.showSliceId)))(Data_Show.showString))))(new Data_Symbol.IsSymbol(function () {
          return "SelNote";
      }))))))(os);
  });
  var eqOuterSelection = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof SelNote && y instanceof SelNote) {
              return x.value0.note === y.value0.note && Data_Eq.eq(Data_Eq.eqArray(Model.eqSliceId))(x.value0.parentSlices)(y.value0.parentSlices);
          };
          return false;
      };
  });
...
(function($PS) {
  ...
  var genericLeftmost = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Leftmost (line 15, column 1 - line 15, column 62): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  exports["LMHorizontalize"] = LMHorizontalize;
  ...
  var reductionToLeftmost = function (reduction) {
      var lmAlg = (function () {
          var splitRight = function (v) {
              return function (v1) {
                  return function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Data_List_Types.Cons.create(new Leftmost.LMSplitRight(Data_Unit.unit))))(function () {
                          return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Data_Identity.monadIdentity))(Data_Functor.map(Data_List_Types.functorList)(nothingMore)(new Data_List_Types.Cons(v2.childl, new Data_List_Types.Cons(v2.childr, Data_List_Types.Nil.value))));
                      });
                  };
              };
          };
          var splitOnly = function (v) {
              return function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Data_List_Types.Cons.create(new Leftmost.LMSplitOnly(Data_Unit.unit))))(function () {
                      return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Data_Identity.monadIdentity))(Data_Functor.map(Data_List_Types.functorList)(nothingMore)(new Data_List_Types.Cons(v1.childl, new Data_List_Types.Cons(v1.childr, Data_List_Types.Nil.value))));
                  });
              };
          };
          var splitLeft = function (v) {
              return function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Data_List_Types.Cons.create(new Leftmost.LMSplitLeft(Data_Unit.unit))))(function () {
                      return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Data_Identity.monadIdentity))(Data_Functor.map(Data_List_Types.functorList)(nothingMore)(new Data_List_Types.Cons(v1.childl, new Data_List_Types.Cons(v1.childr, Data_List_Types.Nil.value))));
                  });
              };
          };
          var hori = function (v) {
              return function (v1) {
                  return function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Data_List_Types.Cons.create(new Leftmost.LMHorizontalize(Data_Unit.unit))))(function () {
                          return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Data_Identity.monadIdentity))(Data_Functor.map(Data_List_Types.functorList)(nothingMore)(new Data_List_Types.Cons(v2.childl, new Data_List_Types.Cons(v2.childm, new Data_List_Types.Cons(v2.childr, Data_List_Types.Nil.value)))));
                      });
                  };
              };
          };
          var freezeOnly = function (v) {
              return Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Data_List_Types.Cons.create(new Leftmost.LMFreezeOnly(Data_Unit.unit)));
          };
          var freezeLeft = function (v) {
              return Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Data_List_Types.Cons.create(new Leftmost.LMFreezeLeft(Data_Unit.unit)));
          };
          return {
              init: function (v) {
                  return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Data_Identity.monadIdentity))(Data_Unit.unit);
      ...
      var agenda = Data_Functor.map(Data_List_Types.functorList)(nothingMore)(reduction.segments);
      return Data_Array.reverse(Data_Array.fromFoldable(Data_List_Types.foldableList)(Data_Function.flip(Control_Monad_State.execState)(Data_List_Types.Nil.value)(walkGraph(lmAlg)(reduction.start)(agenda))));
  };
  var addGraphTrans = function (v) {
      return function (ir) {
          ...
          var add = function (st) {
              ...
              $69.transitions = Data_Map_Internal.insert(Model.ordTransId)(v.id)(trans(st.leftId))(st.transitions);
              return $69;
          };
  ...
  var addGraphSlice = function (slice) {
      return function (depth) {
          ...
          var add = function (st) {
              ...
              $74.maxd = Data_Ord.max(Data_Ord.ordNumber)(depth)(st.maxd);
              $74.maxx = Data_Ord.max(Data_Ord.ordNumber)(slice.x)(st.maxx);
              $74.slices = Data_Map_Internal.insert(Model.ordSliceId)(slice.id)(gslice)(st.slices);
              return $74;
          };
          return Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(add);
      };
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(addGraphTrans(left.seg.trans)(left.seg.rslice.id))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(addGraphSlice(left.seg.rslice)(left.more.rdepth))(function () {
                  return Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(function (st) {
                      ...
                      $86.currentDepth = left.more.rdepth;
                      $86.leftId = left.seg.rslice.id;
                      return $86;
                  });
              });
          });
...
(function($PS) {
  ...
  var white = new Halogen_Svg_Attributes.RGB(255, 255, 255);         
  ...
  var renderLeftmost = function (red) {
      var steps = Unfold.reductionToLeftmost(red);
      return Halogen_HTML_Elements.ol_(Data_Functor.map(Data_Functor.functorArray)(function (step) {
          return Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text(Data_Show.show(Leftmost.showLeftmost(Data_Unit.showUnit)(Data_Unit.showUnit)(Data_Unit.showUnit))(step)) ]);
      })(steps));
  };
  var offset = function (i) {
      return Data_Int.toNumber(i) * 20.0;
  };
  var lightgray = new Halogen_Svg_Attributes.RGB(211, 211, 211);
      ...
      return function (v) {
                              ...
                              return function (drawBg) {
                                  return function (attr) {
                                      ...
                                      var bg = Halogen_Svg_Elements.rect([ Halogen_Svg_Attributes.x(xcoord - scalex(0.24)), Halogen_Svg_Attributes.y(ycoord - 0.5 * offset(1)), Halogen_Svg_Attributes.width(scalex(0.48)), Halogen_Svg_Attributes.height(offset(1)), Halogen_Svg_Attributes.fill((function () {
                                          ...
                                          return new Data_Maybe.Just(white);
                                      })()) ]);
          ...
          var mknote = function (i) {
              return function (note) {
                  var nselected = Common.noteIsSelected(selection)(new Model.Inner(note));
                  var nselectable = v.depth !== 0.0;
                  var label = [ Halogen_HTML_Core.text(Data_Show.show(SimplePitch.simplePitchShow)(note.pitch)), Halogen_Svg_Elements.title([  ])([ Halogen_HTML_Core.text(note.id) ]) ];
                  var attrs = [ cursor("pointer"), Halogen_HTML_Events.onClick(function (v1) {
                      return Common.Select.create((function () {
                          if (nselected) {
                              return Common.SelNone.value;
                          };
                          return new Common.SelNote({
                              note: note.id,
                              parentSlices: Model.getParents(v.slice.parents)
                          });
                      })());
                  }) ];
                  return mknode(label)(scalex(v.slice.x))(scaley(v.depth) + offset(i))(nselected)(nselectable)(nselectable)(attrs);
              };
          };
          ...
          return mknode([ Halogen_HTML_Core.text(Data_Show.show(Model.showStartStop(Data_Show.showArray(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "pitch";
          }))(Data_Show.showRecordFieldsNil)(SimplePitch.simplePitchShow))(Data_Show.showString)))))(v.slice.notes)) ])(scalex(v.slice.x))(scaley(v.depth))(false)(false)(true)([  ]);
      };
  };
  var black = new Halogen_Svg_Attributes.RGB(0, 0, 0);
              ...
              var findPitchIndex = function (v1) {
                  return function (v2) {
                      if (v1 instanceof Model.Inner && v2 instanceof Model.Inner) {
                          return Data_Maybe.fromMaybe(0)(Data_Array.findIndex(Data_Eq.eq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                              return "pitch";
                          }))(SimplePitch.simplePitchEq))()(new Data_Symbol.IsSymbol(function () {
                              return "id";
                          }))(Data_Eq.eqString)))(v1.value0))(v2.value0));
                      };
                      return 0;
                  };
              };
              return Data_Maybe.fromMaybe(Halogen_HTML_Core.text(""))(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Model.ordSliceId)(v.left)(slices))(function (v1) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Model.ordSliceId)(v.right)(slices))(function (v2) {
                      ...
                      var mkedge = function (v3) {
                          ...
                          return Halogen_Svg_Elements.line([ Halogen_Svg_Attributes.x1(scalex(v1.slice.x)), Halogen_Svg_Attributes.y1(scaley(v1.depth) + offset(offl)), Halogen_Svg_Attributes.x2(scalex(v2.slice.x)), Halogen_Svg_Attributes.y2(scaley(v2.depth) + offset(offr)), Halogen_Svg_Attributes.stroke(Data_Maybe.Just.create((function () {
                              if (edgeSelected) {
                                  return selColor;
                              };
                              return black;
                      ...
                      var bar = [ Halogen_Svg_Elements.line(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_Svg_Attributes.x1(scalex(v1.slice.x)), Halogen_Svg_Attributes.y1(scaley(v1.depth)), Halogen_Svg_Attributes.x2(scalex(v2.slice.x)), Halogen_Svg_Attributes.y2(scaley(v2.depth)), Halogen_Svg_Attributes.stroke(Data_Maybe.Just.create((function () {
                          if (transSelected) {
                              return selColor;
                          };
                          return lightgray;
  ...
  var renderReduction = function (reduction) {
      return function (selection) {
          var v = Unfold.evalGraph(reduction);
          var width = scalex(v.maxx + 2.0);
          var svgTranss = Data_Functor.map(Data_Functor.functorArray)(renderTrans(selection)(v.slices))(Data_Array.fromFoldable(Data_List_Types.foldableList)(Data_Map_Internal.values(v.transitions)));
          var svgSlices = Data_Functor.map(Data_Functor.functorArray)(renderSlice(selection))(Data_Array.fromFoldable(Data_List_Types.foldableList)(Data_Map_Internal.values(v.slices)));
          var height = scaley(v.maxd + 4.0);
...
(function($PS) {
              ...
              return function (action) {
                  return Control_Bind.bind((dictMonadEffect.Monad0()).Bind1())(Control_Monad_State_Class.get(dictMonadState))(function (st) {
                      ...
                      if (modelAndSel instanceof Data_Maybe.Just) {
                          ...
                          throw new Error("Failed pattern match at Main (line 52, column 28 - line 54, column 75): " + [ v.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Main (line 50, column 3 - line 54, column 75): " + [ modelAndSel.constructor.name ]);
                  });
              };
          };
      };
  ...
  var appComponent = function (dictMonadEffect) {
      var render = function (st) {
          return Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Proto-Voice Annotation") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              ...
              if (st.model instanceof Data_Maybe.Just) {
                  return Halogen_HTML_Elements.div_([ Render.renderReduction(st.model.value0.reduction)(st.selected), Render.renderLeftmost(st.model.value0.reduction) ]);
              };
              throw new Error("Failed pattern match at Main (line 79, column 9 - line 85, column 16): " + [ st.model.constructor.name ]);
          })(), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Selection: "), Halogen_HTML_Core.text(Data_Show.show(Common.showOuterSelection)(st.selected)) ]) ]);
      };
      ...
      var handleAction = function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 92, column 18 - line 98, column 67): " + [ v.constructor.name ]);
      };
