...
(function($PS) {
  ...
  var showStartStop = function (dictShow) {
      return new Data_Show.Show(function (v) {
          ...
          throw new Error("Failed pattern match at Model (line 154, column 1 - line 157, column 26): " + [ v.constructor.name ]);
      });
  };
  ...
  var getParents = function (v) {
      ...
      throw new Error("Failed pattern match at Model (line 217, column 14 - line 220, column 50): " + [ v.constructor.name ]);
  };
  var getInnerNotes = function (slice) {
      ...
      throw new Error("Failed pattern match at Model (line 230, column 23 - line 233, column 23): " + [ slice.notes.constructor.name ]);
  };
  ...
  var genericParents = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Model (line 211, column 1 - line 211, column 52): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var ordStartStop = function (dictOrd) {
      return new Data_Ord.Ord(function () {
          ...
          return function (y) {
              ...
              throw new Error("Failed pattern match at Model (line 152, column 1 - line 152, column 61): " + [ x.constructor.name, y.constructor.name ]);
          };
      });
  };
...
(function($PS) {
  ...
  var renderTime = function (i) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Render (line 294, column 1 - line 294, column 78): " + [ i.constructor.name, v.constructor.name ]);
      };
  };
          ...
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("height:30px;"), Halogen_HTML_Properties.class_("pure-g") ])((function () {
              if (sel instanceof CommonApp.SelNote) {
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ gridDiv("pure-u-1-4")([ Halogen_HTML_Core.text(Data_Show.show(SimplePitch.simplePitchShow)(sel.value0.note.pitch) + (" (" + (sel.value0.note.id + ") "))) ]) ])((function () {
                      ...
                      throw new Error("Failed pattern match at Render (line 366, column 12 - line 427, column 16): " + [ sel.value0.expl.constructor.name ]);
                  })());
              };
                              ...
                              return function (valid) {
                                  return function (attr) {
                                      ...
                                      var bg = Halogen_Svg_Elements.rect([ Halogen_Svg_Attributes.x(xcoord - scalex(0.24)), Halogen_Svg_Attributes.y(ycoord - 0.5 * offset(1)), Halogen_Svg_Attributes.width(scalex(0.48)), Halogen_Svg_Attributes.height(offset(1)), Halogen_Svg_Attributes.fill((function () {
                                          ...
                                          throw new Error("Failed pattern match at Render (line 127, column 15 - line 130, column 37): " + [ selStatus.constructor.name ]);
                                      })()) ]);
